...
<html lang="pt-br">
    ...
    <head>
        ...
        <title>MarmaMia - Alterar Opção</title>
    </head>
        ...
        <div id="container">
            ...
            <div id="cardapio">
                ...
                <div id="tabelas">
                    ...
                    <form method="post" action="alterar_opcao2.php">
                        ...
                        <fieldset class="form-group">
                            ...
                            <div class="field-group">
                                ...
                                <div class="field">
                                    <label>Nome:</label>
                                    <input type="text" size="50" name="nome" value="<?php echo $dados["nome"]; ?>">
                                </div>
                            ...
                            <div class="field">
                                ...
                                <input type="text" name="descricao" maxlength="100" value="<?php echo $dados["descricao"]; ?>">
                            </div>
                            ...
                            <div class="field-group">
                                ...
                                <div class="field">
                                    ...
                                    <select name="tipo" required>
                                        <option value="<?php echo $dados['tipo']; ?>" selected="selected"> <?php echo $dados['tipo']; ?></option>
