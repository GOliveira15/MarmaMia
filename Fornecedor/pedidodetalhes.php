            ...
            <div id="form-fornecedor-cliente">
                ...
                <div id="form">
                    ...
                    <?php
                        ...
                        echo "<br><h3>Cliente</h3><br>";

                        $query2 = mysqli_query($conexao,"select * from clientes where id_cliente=$id_cliente");
                        ...
                        echo "<b>CPF: </b>".$dados2['cpf']."<br>";	
                        echo "<b>Telefone: </b>".$dados2['telefone']."<br>";
                        echo "<b>E-mail: </b>".$dados2['email']."<br><br>";	
                        ...
                        echo "<b>Total:</b> R$".number_format($dados3['total'], 2, ',', '.').'<br>';

                    ?><br>

                    <hr><br>
                    <div id="botoes">
                        <a href="../Fornecedor/pedidosrecebidos?status=.php">Pedidos Recebidos</a>
                    </div>
