...
<html lang="pt-br">
    ...
    <body>
        <?php
            ...
            $sqlupdate = "update fornecedores set id_fornecedor='$id_fornecedor', nome='$nome', cpf='$cpf', telefone='$telefone', nome_fantasia='$nome_fantasia',
            cnpj='$cnpj', logradouro='$logradouro', numero='$numero', complemento='$complemento', bairro='$bairro', cidade='$cidade', cep='$cep', 
            estado='$estado' where id_fornecedor=$id_fornecedor";
